...
%\multicollinenumbers
\bigskip
\noindent\textbf{To deal with the wicked problem of climate change, international policy-makers need the IPCC. The IPCC makes maps.}

The IPCC sees its role as to ``assess on a comprehensive, objective, open and transparent basis the scientific, technical and socio-economic information relevant to [...] climate change'' \citep{IPCC2013}. This role is vital for....
Making maps \citep{Edenhofer2015}



\bigskip
\noindent\textbf{The task of the IPCC has beome much more difficult with big literature}

Further, it has been pointed out that, in the age of ``big literature'', providing assessments that are comprehensivene, objective and transparent has become much more difficult \citep{Minx2017l}. 
Is the map up to date, does it cover everything?
...
\bigskip
\noindent\textbf{The IPCC, its reports and processes have been the object of study before. These are also hampered problems of scale though}

Various researchers have attempted to do empirical research on the assessment reports, and processes of the inter. alia. the IPCC \citep{jabbour2017} \citep{Bjurström2011}. Policy makers, when asked about their interactions with the IPCC call for a greater focus on solutions \citep{Kowarsch2017}
