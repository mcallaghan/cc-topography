...
The topic model presented here is a rough map of climate change research since 1985. It shows a broad outline of the topics that make up this research and how they relate to each other, and demonstrates how this has changed over time. This relief map should supplement the maps drawn by assessment-makers-as-cartographers for policymakers described in \citet{Edenhofer2015}, by allowing assessment makers to have an overview of unmanageably large and diverse landscape. Moreover, as demonstrated in this paper, such a map can be used as a reference to quantitatively measure whether the more detailed maps produced, for example, in IPCC reports, accurately reflect the underlying landscape. [map metaphor overworked?]
