...
\begin{frame}{Data - Unmatched IPCC References}
	\tiny
	\input{../tables/ipcc_matching_sample.tex}
\end{frame}
...
\begin{frame}
	The documents that underpin this growth
\end{frame}

\begin{frame}{Results - Development}
\only<1->{
	\begin{figure}
		\includegraphics[width=0.6\linewidth]{../plots/development/ar5_growth}	
	\end{figure}
}
\only<1->{
	\centering
...
\only<1->{
\begin{figure}
	\includegraphics[width=0.8\linewidth]{../plots/development/ar6_growth}	
\end{figure}
}
\only<1->{
	\centering
